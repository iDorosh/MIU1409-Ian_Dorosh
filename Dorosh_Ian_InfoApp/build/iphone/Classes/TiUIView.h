...
/**
 Base class for all Dorosh_Ian_InfoApp views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the Dorosh_Ian_InfoApp view hierarchy (such as wrapped iOS UIViews) was touched.
