...
// in simulator we redefine to format for Dorosh_Ian_InfoApp Developer console
...
{\
	NSString * exceptionName = [@"org.dorosh_ian_infoapp." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.dorosh_ian_infoapp";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIDorosh_Ian_InfoAppNativeItemNone = -1, 
	UIDorosh_Ian_InfoAppNativeItemSpinner = -2,
	UIDorosh_Ian_InfoAppNativeItemProgressBar = -3,
	
	UIDorosh_Ian_InfoAppNativeItemSlider = -4,
	UIDorosh_Ian_InfoAppNativeItemSwitch = -5,
	UIDorosh_Ian_InfoAppNativeItemMultiButton = -6,
	UIDorosh_Ian_InfoAppNativeItemSegmented = -7,
	
	UIDorosh_Ian_InfoAppNativeItemTextView = -8,
	UIDorosh_Ian_InfoAppNativeItemTextField = -9,
	UIDorosh_Ian_InfoAppNativeItemSearchBar = -10,
	
	UIDorosh_Ian_InfoAppNativeItemPicker = -11,
	UIDorosh_Ian_InfoAppNativeItemDatePicker = -12,
	
	UIDorosh_Ian_InfoAppNativeItemInfoLight = -13,
	UIDorosh_Ian_InfoAppNativeItemInfoDark = -14,
	
	UIDorosh_Ian_InfoAppNativeItemDisclosure = -15,
	
	UIDorosh_Ian_InfoAppNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Dorosh_Ian_InfoApp instances of
