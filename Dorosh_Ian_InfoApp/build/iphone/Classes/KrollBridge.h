...
@interface Dorosh_Ian_InfoAppObject : KrollCoverageObject {
#else
@interface Dorosh_Ian_InfoAppObject : KrollObject {
#endif
@private
...
extern NSString * Dorosh_Ian_InfoApp$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Dorosh_Ian_InfoAppObject *_dorosh_ian_infoapp;
    KrollObject* console;
	BOOL shutdown;
