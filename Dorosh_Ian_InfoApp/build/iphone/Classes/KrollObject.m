...
//@interface Dorosh_Ian_InfoAppObject : NSObject
//@end

@interface Dorosh_Ian_InfoAppObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Dorosh_Ian_InfoAppObject class]])
		{
			for (NSString *key in [[(Dorosh_Ian_InfoAppObject*)o modules] allKeys])
			{
