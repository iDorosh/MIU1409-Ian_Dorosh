 ...
 * to send analytic data that can be viewed on the Dorosh_Ian_UtilityApp Dashboard.
 *
 * For information on getting started with Dorosh_Ian_UtilityApp Platform Services,
