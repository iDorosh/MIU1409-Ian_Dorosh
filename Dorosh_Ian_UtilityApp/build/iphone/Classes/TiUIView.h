...
/**
 Base class for all Dorosh_Ian_UtilityApp views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the Dorosh_Ian_UtilityApp view hierarchy (such as wrapped iOS UIViews) was touched.
