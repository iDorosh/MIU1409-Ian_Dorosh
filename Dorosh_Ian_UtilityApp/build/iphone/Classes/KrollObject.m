...
//@interface Dorosh_Ian_UtilityAppObject : NSObject
//@end

@interface Dorosh_Ian_UtilityAppObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Dorosh_Ian_UtilityAppObject class]])
		{
			for (NSString *key in [[(Dorosh_Ian_UtilityAppObject*)o modules] allKeys])
			{
