...
// in simulator we redefine to format for Dorosh_Ian_UtilityApp Developer console
...
{\
	NSString * exceptionName = [@"org.dorosh_ian_utilityapp." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.dorosh_ian_utilityapp";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIDorosh_Ian_UtilityAppNativeItemNone = -1, 
	UIDorosh_Ian_UtilityAppNativeItemSpinner = -2,
	UIDorosh_Ian_UtilityAppNativeItemProgressBar = -3,
	
	UIDorosh_Ian_UtilityAppNativeItemSlider = -4,
	UIDorosh_Ian_UtilityAppNativeItemSwitch = -5,
	UIDorosh_Ian_UtilityAppNativeItemMultiButton = -6,
	UIDorosh_Ian_UtilityAppNativeItemSegmented = -7,
	
	UIDorosh_Ian_UtilityAppNativeItemTextView = -8,
	UIDorosh_Ian_UtilityAppNativeItemTextField = -9,
	UIDorosh_Ian_UtilityAppNativeItemSearchBar = -10,
	
	UIDorosh_Ian_UtilityAppNativeItemPicker = -11,
	UIDorosh_Ian_UtilityAppNativeItemDatePicker = -12,
	
	UIDorosh_Ian_UtilityAppNativeItemInfoLight = -13,
	UIDorosh_Ian_UtilityAppNativeItemInfoDark = -14,
	
	UIDorosh_Ian_UtilityAppNativeItemDisclosure = -15,
	
	UIDorosh_Ian_UtilityAppNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Dorosh_Ian_UtilityApp instances of
