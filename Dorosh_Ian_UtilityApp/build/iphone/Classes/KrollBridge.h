...
@interface Dorosh_Ian_UtilityAppObject : KrollCoverageObject {
#else
@interface Dorosh_Ian_UtilityAppObject : KrollObject {
#endif
@private
...
extern NSString * Dorosh_Ian_UtilityApp$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Dorosh_Ian_UtilityAppObject *_dorosh_ian_utilityapp;
    KrollObject* console;
	BOOL shutdown;
