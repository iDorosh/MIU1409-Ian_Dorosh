	...
	"aboutMe":{
		...
		"questions": [
			...
			},
			{
				...
				description: "I really enjoy art wether its drawing painting jewlery or ceramics I tried it all and have won competitions back in highschool for my ceramics pieces.", 
			},
		]
	}
};
...
var detail = function(data){
	...
	detailWindow.add(detailTextBackground, questionBox);
